...
export default function Home() {
  ...
  const EstimateSEL = (amount) => {
    ...
    if (slippage === '10') {
      return (amount * selectedTokenPrice) / 0.0000125;
    }
  ...
  return (
    <Container>
      ...
      >
        <div>
          ...
          <Row align="middle" justify="space-between">
            ...
            <Col span={12}>
              <Text>: For the launch at pancakeswap private investors will have 100% of their investment.</Text>
            </Col>
          </Row>
          <br />
      ...
      <br />
      <center>
        <p className="home-title">Bombercash</p>
        <p className="home-sub-title">Private presale event</p>
        <br />
      </center>
      <CardStyled>
            ...
            {priceLoading ? (
              ...
              <Row justify="space-between" align="middle">
                ...
                <div style={{ width: '35%', display: 'inline' }}>
                  ...
                  <span style={{ color: '#fff', marginLeft: '10px' }}>BOMB</span>
                </div>
              </Row>
            )}
          </FormItem>
          <Row justify="end" style={{ paddingBottom: '20px' }}>
            <Text>Profit {100}%</Text>
            <Button
      ...
      <p style={{wordBreak: 'break-word'}}>
        ...
        4. Enter the contribution amount in BNB, BUSD, USDT. <br />
        5. Press Contribute. <br />
        <br />
        OFFICIAL BOMB TOKEN ADDRESS :
        SOON
      </p>
    </Container>
  );
